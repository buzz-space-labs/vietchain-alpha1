...
// source: anam/smartaccount/tx.proto
...
func init() {
	proto.RegisterType((*MsgRecover)(nil), "anam.smartaccount.MsgRecover")
	proto.RegisterType((*MsgRecoverResponse)(nil), "anam.smartaccount.MsgRecoverResponse")
	proto.RegisterType((*MsgActivateAccount)(nil), "anam.smartaccount.MsgActivateAccount")
	proto.RegisterType((*MsgActivateAccountResponse)(nil), "anam.smartaccount.MsgActivateAccountResponse")
}

func init() { proto.RegisterFile("anam/smartaccount/tx.proto", fileDescriptor_a5e57911088fb05d) }
...
func (c *msgClient) Recover(ctx context.Context, in *MsgRecover, opts ...grpc.CallOption) (*MsgRecoverResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anam.smartaccount.Msg/Recover", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ActivateAccount(ctx context.Context, in *MsgActivateAccount, opts ...grpc.CallOption) (*MsgActivateAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anam.smartaccount.Msg/ActivateAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Recover_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anam.smartaccount.Msg/Recover",
	}
...
func _Msg_ActivateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anam.smartaccount.Msg/ActivateAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "anam.smartaccount.Msg",
	...
	Metadata: "anam/smartaccount/tx.proto",
}
